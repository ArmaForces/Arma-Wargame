...
private _iconMode = EGVAR(icons,unitIconMode);
...
if (!isNull findDisplay 312) then {
    ...
    if (_type isEqualTo "GROUP") then {
        ...
        } forEach ([_entity] call EFUNC(common,getGroupVehicles));
    };
