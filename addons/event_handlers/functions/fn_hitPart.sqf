...
private _hitDir = [_target, _vector, _velocity, _projectile] call EFUNC(damage,getHitDir);
...
[_target, _shooter, _hitDir, _hitPosition, _velocity, _projectile, _ammo] call EFUNC(damage,calculateAndApplyDamage);
