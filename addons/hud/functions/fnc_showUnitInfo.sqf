...
private _unitInfo = [_unit] call EFUNC(common,getVehicleInfo);

if (_unitInfo isEqualTo objNull) exitWith {};

private _messageParts = [
    [_unitInfo] call EFUNC(common,getVehicleDisplayName),
    lineBreak,
    lineBreak,
...
private _ammoInfo = [_unit] call EFUNC(common,getAmmoInfo);
